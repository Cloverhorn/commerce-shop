                    ...
                    {Menu.map((item) => (
                        <>
                            ...
                            >
                                ...
                                {item.dropdown && (
                                    // REF
                                    <ul className='bg-white absolute top-[32px] right-[-10px] transition-all duration-200 z-[99999] rounded-md w-[100%] hidden group-hover:block shadow-md' ref={myRef}>
                                        {item.dropdown.map((dropItem) => (
                                            <li key={dropItem.key} className='px-4 py-1 hover:bg-primary/20 dark:text-black'>
